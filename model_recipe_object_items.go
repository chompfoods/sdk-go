...
type RecipeObjectItems struct {
	// Unique recipe ID
	Id string `json:"id,omitempty"`
	// Recipe title
	Title string `json:"title,omitempty"`
	Meta *RecipeObjectMeta `json:"meta,omitempty"`
	Categories []string `json:"categories,omitempty"`
	// The author of this recipe. You must attribute this author when displaying this recipe.
	Author string `json:"author,omitempty"`
	Keywords []string `json:"keywords,omitempty"`
	Topics []string `json:"topics,omitempty"`
	Attributes *RecipeObjectAttributes `json:"attributes,omitempty"`
	// An array containing this recipe's ingredients
	Ingredients []RecipeObjectIngredients `json:"ingredients,omitempty"`
	BaseIngredients []string `json:"base_ingredients,omitempty"`
	Nutrients *RecipeObjectNutrients `json:"nutrients,omitempty"`
	DiabeticExchanges []string `json:"diabetic_exchanges,omitempty"`
}
