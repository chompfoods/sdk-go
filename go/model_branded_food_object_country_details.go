...
type BrandedFoodObjectCountryDetails struct {
	// The number of countries where English is the country's primary language
	EnglishSpeaking int32 `json:"english_speaking,omitempty"`
	// The number of countries where English is not the country's primary language
	NonEnglishSpeaking int32 `json:"non_english_speaking,omitempty"`
}
