...
type BrandedFoodObjectPackagingPhotos struct {

	Front *BrandedFoodObjectPackagingPhotosFront `json:"front,omitempty"`

	Nutrition *BrandedFoodObjectPackagingPhotosNutrition `json:"nutrition,omitempty"`

	Ingredients *BrandedFoodObjectPackagingPhotosIngredients `json:"ingredients,omitempty"`
}
